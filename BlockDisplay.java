...
public class BlockDisplay extends JComponent implements KeyListener
{
     ...
     * Sets the title of the window.
     * 
     * @param title  the title to be placed at the
     *               top of the window
     * @param score  the score to be placed at the
     *               top of the window  
     * @param level  the level to be placed at the
     *               top of the window
     */
    public void setTitle(String title, int score, int level)
    {
        frame.setTitle(title+"\tLevel: "+level+"\tPoints: "+score);
    }
